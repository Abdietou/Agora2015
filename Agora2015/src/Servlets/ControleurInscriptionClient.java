...
public class ControleurInscriptionClient extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		String action = req.getParameter("Valider");
		if (action.equals("Save")){
			...
			String cp = req.getParameter("code_postal");
			String telephone = req.getParameter("telephone");
			String mail = req.getParameter("mail");
			String login = req.getParameter("login");
			String password = req.getParameter("password");
			
			client.addClient(new ClientInscriptionEntity(nom, prenom, adresse, ville, cp, telephone, mail, login, password));
		}
